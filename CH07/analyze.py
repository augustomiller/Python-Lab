...
[] Calcular o numero de silabas, (heuristica).
    ...
    [x] Tratamos o caractere y como uma vogal se estiver no final da palavra.

The analyze module uses the Flesch-Kincaid readability test to analyze text and produce a readability score.
This score is then converted int a grade-based readability category.s
"""


# retorna o numero total de silabas de todas as palavras.
def count_syllables(words):
    """ This function takes a list of word and returns a total
...
def output_results(score):
    """ This function takes a Flesch-Kincaid score and print the corresponding
        reading level.
    """
